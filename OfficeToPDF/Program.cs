...
namespace OfficeToPDF
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            options["delete_current_date_fields"] = false;
